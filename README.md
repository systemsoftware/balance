...
* **Advanced Tabs & Windows**: Support for duplicating tabs and launching pages into new windows.
* **Customizable Experience**:
    ...
    * **Persistent Storage**: History and bookmarks are managed via **SwiftData**.
